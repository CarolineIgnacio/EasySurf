 ...
 */
public class TelaAcessoFuncionario extends javax.swing.JFrame {
    
    public static TelaAcessoFuncionario instance;
    String senha;

    /**
     * Creates new form TelaAcessoFuncionario
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAcessoFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAcessoFuncionario().setVisible(true);
            }
        });
    }
